        ...
        if(!is_null($request->fecha)){
            switch (@$request->fecha) {
                case 'diaActual':
                    ...
                    $reservaciones = Reservacion::whereBetween("fecha", [$fechaInicio,$fechaFinal])->where('estatus',1)->orderBy('check_in','asc')->get();
                    break;
                case 'futuros':
                    $fechaInicio = Carbon::now()->startOfDay();
                ...
                case 'pasados':
                    ...
                    $reservaciones = Reservacion::whereBetween("fecha", [$fechaInicio,$fechaFinal])->where('check_in',0)->where('estatus',1)->orderBy('id','asc')->get();
                    break;
            }   
        }
