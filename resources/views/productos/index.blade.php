                        ...
                        <div class="container">
                            <form class="row g-3 align-items-center f-auto" id="productos-form">
                                ...
                                <div class="form-group col-2 mt-2">
                                    ...
                                    <input type="text" name="costo" class="form-control amount">
                                </div>
                                <div class="form-group col-2 mt-2">
                                    <label for="precioVenta" class="col-form-label">Precio venta</label>
                                    <input type="text" name="precioVenta" class="form-control amount">
                                </div>
                                <div class="form-group col-2 mt-3">
                                    <button class="btn btn-info btn-block mt-33" id="crear-producto">Crear producto</button>
                                </div>
                            </form>
                        </div>
                    </div>
