                            ...
                            <div class="form-group col-12 mt-0 mb-0">
                                <div class="row">
                                    ...
                                    <div class="form-group col-6 mt-0 mb-0">
                                        ...
                                        <input type="text" name="nombre" class="form-control to-uppercase" required="required" autocomplete="off" tabindex="6" value="{{@$venta->nombre_cliente}}" disabled="disabled">
                                    </div>
