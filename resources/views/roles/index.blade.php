    ...
    function changeRoles(roles){
        ...
        axios.post('/roles', {
            ...
            'permisos'                 : {
                ...
                'TiposComisionista.index'     : roles.elements['TiposComisionista.index'       ].checked,
                'TiposComisionista.create'    : roles.elements['TiposComisionista.create'      ].checked,
                'TiposComisionista.update'    : roles.elements['TiposComisionista.update'      ].checked,
          ...
          <div class="main-card mb-3 card">
            <div class="card-body">
                ...
                <form class="row g-3 f-auto" id="roles-form">
                    ...
                    <div class="col-md-2">
                        <strong>Comisionista tipos</strong>
                        <div class="checkbox checkbox-primary">
                            <input name="TiposComisionista.index" type="checkbox" >
                            <label for="TiposComisionista.index">
                                Ver 
                            </label>
                        </div>
                        <div class="checkbox checkbox-primary">
                            <input name="TiposComisionista.create" type="checkbox" >
                            <label for="TiposComisionista.create">
                                Crear 
                            </label>
                        </div>
                        <div class="checkbox checkbox-primary">
                            <input name="TiposComisionista.update" type="checkbox" >
                            <label for="TiposComisionista.update">
                                Modificar 
                            </label>
                        </div>
                    </div>
