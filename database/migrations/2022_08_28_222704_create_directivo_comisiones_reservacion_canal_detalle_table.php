...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('directivo_comisiones_reservacion_canal_detalle', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('directivo_comisiones_reservacion_canal_detalle');
    }
};
